...
PRODUCT_COPY_FILES := \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/irsc_util:system/vendor/bin/irsc_util:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/mm-qcamera-daemon:system/vendor/bin/mm-qcamera-daemon:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/mpdecision:system/vendor/bin/mpdecision:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/netmgrd:system/vendor/bin/netmgrd:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/qmuxd:system/vendor/bin/qmuxd:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/qseecomd:system/vendor/bin/qseecomd:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/rmt_storage:system/vendor/bin/rmt_storage:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/sensors.qcom:system/vendor/bin/sensors.qcom:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/subsystem_ramdump:system/vendor/bin/subsystem_ramdump:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/thermal-engine-hh:system/vendor/bin/thermal-engine-hh:qcom \
    $(VENDOR_QCOM_PATH)/hammerhead/proprietary/vendor/bin/time_daemon:system/vendor/bin/time_daemon:qcom \
